...
public class GameLogic {
	...
	static boolean playerTurn(int numberOfFirstPlayerMovesInGame, int numberOfSecondPlayerMovesInGame,
		...
		Boolean playerTurn = (isFirstPlayerTurn && numberOfFirstPlayerMovesInGame == numberOfSecondPlayerMovesInGame)
				|| (!isFirstPlayerTurn && numberOfSecondPlayerMovesInGame == (numberOfFirstPlayerMovesInGame - 1))
						? true
						: false;
		return playerTurn;
	}
